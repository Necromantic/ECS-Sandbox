...
namespace toinfiniityandbeyond.Examples
{
    public sealed class SpriteRendererSceneBootstrap
    {
        ...
        public static void InitializeAfterScene()
        {
            ...
            {
                AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ecs-instanced-sprite-renderer/Sprite Rendering Example/Sprites/elephant.png"),
                AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ecs-instanced-sprite-renderer/Sprite Rendering Example/Sprites/giraffe.png"),
                AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ecs-instanced-sprite-renderer/Sprite Rendering Example/Sprites/zebra.png"),
            };
            ...
            for (int i = 0; i < 10000; i++)
            {
                var entity = entityManager.CreateEntity(ComponentType.Create<Position2D>(),
                                                        ...
                                                        ComponentType.Create<SpriteColor>(),
                                                        ComponentType.Create<SpriteUniformScale>());
                ...
                entityManager.SetComponentData(entity, new SpriteColor
                {
                    Value = new Color(Random.value, Random.value, Random.value)
                });

                entityManager.SetComponentData(entity, new SpriteUniformScale
                {
                    Value = Random.value
                });
